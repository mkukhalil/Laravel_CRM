...
<div class="row g-4">
    <div class="col-md-3">
        <x-metric-card title="My Leads" :count="$leadCount" icon="bi-person-check-fill" href="{{ route('leads.index') }}" :trend="$leadTrend" />
    </div>
    <div class="col-md-3">
        <x-metric-card title="My Tasks" :count="$assignedTasks" icon="bi-list-check" href="{{ route('tasks.index') }}" :trend="$taskTrend" />
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-3">
        <x-metric-card title="Clients" :count="$clientsCount" icon="bi-people" href="{{ route('clients.index') }}"   />
    </div>
</div>
